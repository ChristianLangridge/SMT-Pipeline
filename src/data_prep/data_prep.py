from spatialmt.data_preparation.prep import prepare_dataset, generate_pseudotime_labels
...
if __name__ == "__main__":
    ...
    pseudotime.reset_index(drop=True).to_csv(out_dir / "pseudotime_labels.csv", index=False)
